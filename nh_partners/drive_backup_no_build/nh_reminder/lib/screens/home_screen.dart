...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  Future<void> _resetToDefaultLocation() async {
    ...
    try {
      ...
      final judgment = await _getCurrentJudgment(updated);
      ...
      if (!mounted) return;
      final statusText = judgment == null
          ? '현재 범위 상태는 확인하지 못했습니다.'
          : inRange
      ...
      messenger.showSnackBar(
        SnackBar(
          ...
          backgroundColor:
              inRange ? const Color(0xFF4DB6AC) : const Color(0xFFFF9800),
        ),
      );
    } catch (e) {
      if (!mounted) return;
