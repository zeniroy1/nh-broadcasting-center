...
class NhGeofenceService {
  ...
  Future<void> stop({bool clearDismissal = true}) async {
    return _enqueueOperation(
      () => _stopInternal(clearDismissal: clearDismissal),
    );
  }

  Future<void> _stopInternal({required bool clearDismissal}) async {
