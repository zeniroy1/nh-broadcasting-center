...
class BackgroundMonitorService {
  ...
  static Future<LocationJudgment?> _judgmentFromLastKnownForDismissed({
    ...
    final confirmedExitThreshold =
        LocationJudgmentService.confirmedExitThreshold(radius);
    final distanceToConfirmedExit = confirmedExitThreshold - judgment.distance;
    if (distanceToConfirmedExit <= dismissedNearConfirmedExitMeters) {
      return null;
    }
  ...
  static int _delayForDismissedLowPower(LocationJudgment judgment) {
    final confirmedExitThreshold =
        LocationJudgmentService.confirmedExitThreshold(judgment.radius);
    final distanceToConfirmedExit = confirmedExitThreshold - judgment.distance;
    if (distanceToConfirmedExit <= dismissedNearConfirmedExitMeters) {
